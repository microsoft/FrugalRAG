...
def load_wiki18_corpus(path=None):
    # TODO --> using hard coded default path for now
    path  = path if path else "/mnt/ddn/alta01/t-abjava/data/wiki18_100w.jsonl"
    if not os.path.exists(path):
        path ="/data/wiki18_100w.jsonl"
